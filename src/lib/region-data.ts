...
export const regionData: RegionData[] = [
  {
    province: '北京市',
    cities: [{ city: '北京市', districts: ['东城区', '西城区', '朝阳区', '丰台区', '石景山区', '海淀区', '门头沟区', '房山区', '通州区', '顺义区', '昌平区', '大兴区', '怀柔区', '平谷区', '密云区', '延庆区'] }]
  },
  {
    province: '上海市',
    cities: [{ city: '上海市', districts: ['黄浦区', '徐汇区', '长宁区', '静安区', '普陀区', '虹口区', '杨浦区', '闵行区', '宝山区', '嘉定区', '浦东新区', '金山区', '松江区', '青浦区', '奉贤区', '崇明区'] }]
  },
  {
    province: '天津市',
    cities: [{ city: '天津市', districts: ['和平区', '河东区', '河西区', '南开区', '河北区', '红桥区', '东丽区', '西青区', '津南区', '北辰区', '武清区', '宝坻区', '滨海新区', '宁河区', '静海区', '蓟州区'] }]
  },
  {
    province: '重庆市',
    cities: [{ city: '重庆市', districts: ['万州区', '涪陵区', '渝中区', '大渡口区', '江北区', '沙坪坝区', '九龙坡区', '南岸区', '北碚区', '綦江区', '大足区', '渝北区', '巴南区', '黔江区', '长寿区', '江津区', '合川区', '永川区', '南川区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区', '城口县', '丰都县', '垫江县', '忠县', '云阳县', '奉节县', '巫山县', '巫溪县', '石柱土家族自治县', '秀山土家族苗族自治县', '酉阳土家族苗族自治县', '彭水苗族土家族自治县'] }]
  },
  {
    province: '河北省',
    cities: [
      { city: '石家庄市', districts: ['长安区', '桥西区', '新华区', '裕华区', '井陉矿区', '藁城区', '鹿泉区', '栾城区', '井陉县', '正定县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县', '平山县', '元氏县', '赵县', '辛集市', '晋州市', '新乐市'] },
      { city: '唐山市', districts: ['路南区', '路北区', '古冶区', '开平区', '丰南区', '丰润区', '曹妃甸区', '滦南县', '乐亭县', '迁西县', '玉田县', '遵化市', '迁安市'] },
      ...
      { city: '邢台市', districts: ['襄都区', '信都区', '任泽区', '南和区', '临城县', '内丘县', '柏乡县', '隆尧县', '宁晋县', '巨鹿县', '新河县', '广宗县', '平乡县', '威县', '清河县', '临西县', '南宫市', '沙河市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '临汾市', districts: ['尧都区', '曲沃县', '翼城县', '襄陵县', '洪洞县', '古县', '安泽县', '浮山县', '吉县', '乡宁县', '大宁县', '隰县', '永和县', '蒲县', '汾西县', '侯马市', '霍州市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '通辽市', districts: ['科尔沁区', '科尔沁左翼中旗', '科尔沁左翼后旗', '开鲁县', '库伦旗', '奈曼旗', '扎鲁特旗', '霍林郭勒市'] },
      { city: '鄂尔多斯市', districts: ['东胜区', '康巴什区', '达拉特旗', '准格尔旗', '鄂托克前旗', '鄂托克旗', '杭锦旗', '乌审旗', '伊金霍洛旗'] },
      { city: '呼伦贝尔市', districts: ['海拉尔区', '扎赉诺尔区', '阿荣旗', '莫力达瓦达斡尔族自治旗', '鄂伦春自治旗', '鄂温克族自治旗', '陈巴尔虎旗', '新巴尔虎左旗', '新巴尔虎右旗', '满洲里市', '牙克石市', '扎兰屯市', '额尔古纳市', '根河市'] },
      { city: '巴彦淖尔市', districts: ['临河区', '五原县', '磴口县', '乌拉特前旗', '乌拉特中旗', '乌拉特后旗', '杭锦后旗'] },
      { city: '乌兰察布市', districts: ['集宁区', '卓资县', '化德县', '商都县', '兴和县', '凉城县', '察哈尔右翼前旗', '察哈尔右翼中旗', '察哈尔右翼后旗', '四子王旗', '丰镇市'] },
      { city: '兴安盟', districts: ['乌兰浩特市', '阿尔山市', '科尔沁右翼前旗', '科尔沁右翼中旗', '扎赉特旗', '突泉县'] },
      { city: '锡林郭勒盟', districts: ['二连浩特市', '锡林浩特市', '阿巴嘎旗', '苏尼特左旗', '苏尼特右旗', '东乌珠穆沁旗', '西乌珠穆沁旗', '太仆寺旗', '镶黄旗', '正镶白旗', '正蓝旗', '多伦县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '牡丹江市', districts: ['东安区', '阳明区', '爱民区', '西安区', '林口县', '绥芬河市', '海林市', '宁安市', '穆棱市', '东宁市'] },
      { city: '黑河市', districts: ['爱辉区', '嫩江市', '逊克县', '孙吴县', '北安市', '五大连池市'] },
      { city: '绥化市', districts: ['北林区', '望奎县', '兰西县', '青冈县', '庆安县', '明水县', '绥棱县', '安达市', '肇东市', '海伦市'] },
      { city: '大兴安岭地区', districts: ['呼玛县', '塔河县', '漠河市'] }
    ]
  },
  {
    province: '江苏省',
    cities: [
      ...
      { city: '无锡市', districts: ['锡山区', '惠山区', '滨湖区', '江阴市', '宜兴市'] },
      { city: '徐州市', districts: ['云龙区', '鼓楼区', '贾汪区', '泉山区', '铜山区', '丰县', '沛县', '睢宁县', '邳州市', '新沂市'] },
      { city: '常州市', districts: ['天宁区', '钟楼区', '新北区', '武进区', '金坛区', '溧阳市'] },
      { city: '苏州市', districts: ['姑苏区', '虎丘区', '吴中区', '相城区', '吴江区', '昆山市', '常熟市', '张家港市', '太仓市'] },
      { city: '南通市', districts: ['崇川区', '通州区', '海门区', '如东县', '启东市', '如皋市', '海安市'] },
  ...
  },
  {
    province: '浙江省',
    cities: [
      { city: '杭州市', districts: ['上城区', '拱墅区', '西湖区', '滨江区', '萧山区', '余杭区', '富阳区', '临安区', '桐庐县', '淳安县', '建德市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '芜湖市', districts: ['镜湖区', '弋江区', '鸠江区', '湾沚区', '繁昌区', '南陵县', '无为市'] },
      ...
      { city: '安庆市', districts: ['迎江区', '大观区', '宜秀区', '怀宁县', '潜山市', '太湖县', '宿松县', '望江县', '岳西县'] },
      ...
      { city: '宣城市', districts: ['宣州区', '郎溪县', '广德市', '泾县', '绩溪县', '旌德县', '宁国市'] }
    ]
  },
  {
    province: '福建省',
    cities: [
      ...
      { city: '三明市', districts: ['三元区', '沙县区', '明溪县', '清流县', '宁化县', '大田县', '尤溪县', '将乐县', '泰宁县', '建宁县', '永安市'] },
      { city: '泉州市', districts: ['鲤城区', '丰泽区', '洛江区', '泉港区', '惠安县', '安溪县', '永春县', '德化县', '石狮市', '晋江市', '南安市'] },
      { city: '漳州市', districts: ['芗城区', '龙文区', '龙海区', '云霄县', '漳浦县', '诏安县', '长泰区', '东山县', '南靖县', '平和县', '华安县'] },
  ...
  },
  {
    province: '江西省',
    cities: [
      { city: '南昌市', districts: ['东湖区', '西湖区', '青云谱区', '青山湖区', '新建区', '南昌县', '进贤县', '安义县'] },
      ...
      { city: '赣州市', districts: ['章贡区', '南康区', '赣县区', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '龙南市', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '瑞金市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '洛阳市', districts: ['老城区', '西工区', '瀍河回族区', '涧西区', '洛龙区', '孟津区', '新安县', '栾川县', '嵩县', '汝阳县', '宜阳县', '洛宁县', '伊川县', '偃师区'] },
      ...
      { city: '新乡市', districts: ['红旗区', '卫滨区', '凤泉区', '牧野区', '新乡县', '获嘉县', '原阳县', '延津县', '封丘县', '长垣市'] },
      ...
      { city: '三门峡市', districts: ['湖滨区', '陕州区', '渑池县', '卢氏县', '灵宝市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '荆门市', districts: ['东宝区', '掇刀区', '沙洋县', '钟祥市', '京山市'] },
      { city: '孝感市', districts: ['孝南区', '孝昌县', '大悟县', '云梦县', '应城市', '安陆市', '汉川市'] },
      { city: '荆州市', districts: ['沙市区', '荆州区', '公安县', '监利市', '江陵县', '石首市', '洪湖市', '松滋市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '湘潭市', districts: ['雨湖区', '岳塘区', '湘潭县', '韶山市', '湘乡市'] },
      { city: '衡阳市', districts: ['珠晖区', '雁峰区', '石鼓区', '蒸湘区', '南岳区', '衡阳县', '衡南县', '衡山县', '衡东县', '祁东县', '耒阳市', '常宁市'] },
      { city: '邵阳市', districts: ['双清区', '大祥区', '北塔区', '邵东市', '新邵县', '邵阳县', '隆回县', '洞口县', '绥宁县', '新宁县', '城步苗族自治县', '武冈市'] },
      ...
      { city: '永州市', districts: ['零陵区', '冷水滩区', '祁阳市', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '百色市', districts: ['右江区', '田阳区', '田东县', '平果市', '德保县', '靖西市', '那坡县', '凌云县', '乐业县', '田林县', '西林县', '隆林各族自治县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '五指山市', districts: ['五指山市'] },
      { city: '琼海市', districts: ['琼海市'] },
      { city: '文昌市', districts: ['文昌市'] },
      { city: '万宁市', districts: ['万宁市'] },
      { city: '东方市', districts: ['东方市'] },
      { city: '定安县', districts: ['定安县'] },
      { city: '屯昌县', districts: ['屯昌县'] },
      { city: '澄迈县', districts: ['澄迈县'] },
      { city: '临高县', districts: ['临高县'] },
      { city: '白沙黎族自治县', districts: ['白沙黎族自治县'] },
      { city: '昌江黎族自治县', districts: ['昌江黎族自治县'] },
      { city: '乐东黎族自治县', districts: ['乐东黎族自治县'] },
      { city: '陵水黎族自治县', districts: ['陵水黎族自治县'] },
      { city: '保亭黎族苗族自治县', districts: ['保亭黎族苗族自治县'] },
      { city: '琼中黎族苗族自治县', districts: ['琼中黎族苗族自治县'] },
      { city: '三沙市', districts: ['三沙市'] }
    ]
  },
  {
    province: '四川省',
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '毕节市', districts: ['七星关区', '大方县', '黔西市', '金沙县', '织金县', '纳雍县', '威宁彝族回族苗族自治县', '赫章县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '曲靖市', districts: ['麒麟区', '沾益区', '马龙区', '陆良县', '师宗县', '罗平县', '富源县', '会泽县', '宣威市'] },
      { city: '玉溪市', districts: ['红塔区', '江川区', '澄江市', '通海县', '华宁县', '易门县', '峨山彝族自治县', '新平彝族傣族自治县', '元江哈尼族彝族傣族自治县'] },
      { city: '保山市', districts: ['隆阳区', '施甸县', '腾冲市', '龙陵县', '昌宁县'] },
      ...
      { city: '楚雄彝族自治州', districts: ['楚雄市', '双柏县', '牟定县', '南华县', '姚安县', '大姚县', '永仁县', '元谋县', '武定县', '禄丰县'] },
      { city: '红河哈尼族彝族自治州', districts: ['蒙自市', '个旧市', '开远市', '弥勒市', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '绿春县', '屏边苗族自治县', '金平苗族瑶族傣族自治县', '河口瑶族自治县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '林芝市', districts: ['巴宜区', '工布江达县', '米林市', '墨脱县', '波密县', '察隅县', '朗县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '咸阳市', districts: ['秦都区', '渭城区', '杨陵区', '兴平市', '武功县', '三原县', '泾阳县', '乾县', '礼泉县', '永寿县', '彬州市', '长武县', '旬邑县', '淳化县'] },
      ...
      { city: '安康市', districts: ['汉滨区', '汉阴县', '石泉县', '宁陕县', '紫阳县', '岚皋县', '平利县', '镇坪县', '旬阳县', '白河县'] },
  ...
  },
  {
    province: '青海省',
    cities: [
      { city: '西宁市', districts: ['城东区', '城中区', '城西区', '城北区', '大通回族土族自治县', '湟中县', '湟源县'] },
      { city: '海东市', districts: ['乐都区', '平安区', '民和回族土族自治县', '互助土族自治县', '化隆回族自治县', '循化撒拉族自治县'] },
      { city: '海北藏族自治州', districts: ['门源回族自治县', '祁连县', '海晏县', '刚察县'] },
      ...
      { city: '海西蒙古族藏族自治州', districts: ['德令哈市', '格尔木市', '茫崖市', '乌兰县', '都兰县', '天峻县'] }
    ]
  },
  {
    province: '宁夏回族自治区',
  ...
  },
  {
    ...
    cities: [
      ...
      { city: '克拉玛依市', districts: ['独山子区', '克拉玛依区', '白碱滩区', '乌尔禾区'] },
      ...
      { city: '博尔塔拉蒙古自治州', districts: ['博乐市', '精河县', '温泉县'] },
      ...
      { city: '石河子市', districts: ['石河子市'] },
      { city: '阿拉尔市', districts: ['阿拉尔市'] },
      { city: '图木舒克市', districts: ['图木舒克市'] },
      { city: '五家渠市', districts: ['五家渠市'] }
    ]
  }
];

export function getRegions(province?: string, city?: string): string[] {
  if (!province) {
    return regionData.map((r) => r.province);
  }

  const provinceData = regionData.find((r) => r.province === province);
  if (!provinceData) {
    return [];
  }

  if (!city) {
    return provinceData.cities.map((c) => c.city);
  }

  const cityData = provinceData.cities.find((c) => c.city === city);
